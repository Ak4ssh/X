...
X is a framework written from the ground up that acts as a fully-fledged Telegram client based on the MTProto
API. This means that X is able to execute any official client and bot API action and more. This page will
therefore show you why X might be a better choice for your project by comparing the two APIs, but first, let's
...
Here is a non-exhaustive list of all the advantages in using MTProto-based libraries -- such as X -- instead of
the official HTTP Bot API. Using X you can:
