...
This page contains example scripts to show you how X looks like.
...
.. csv-table::
    ...
    :doc:`welcome_bot`, "The Welcome Bot in @XChat"
...
For more advanced examples, see https://snippets.X.org.
