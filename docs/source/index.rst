...
.. raw:: html
    ...
    <div align="center">
        <a href="/">
            <div class="X-logo-index"><img src="_static/X.png" alt="X"></div>
            <div class="X-text X-text-index">X</div>
        </a>
    </div>
...
**X** is a modern, elegant and asynchronous :doc:`MTProto API <topics/mtproto-vs-botapi>` framework.
...
- `Become an OpenCollective backer <https://opencollective.com/X>`_.
...
.. hlist::
    ...
    - :doc:`Invoking Methods <start/invoking>`: How to call X's methods.
...
.. hlist::
    ...
    - :doc:`X Client <api/client>`: Reference details about the Client class.
...
.. hlist::
    ...
    - :doc:`X FAQ <faq/index>`: Answers to common X questions.
    - :doc:`Support X <support>`: Ways to show your appreciation.
    - :doc:`Release Notes <releases/index>`: Release notes for X releases.
