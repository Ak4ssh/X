...
The next few steps serve as a quick start to see X in action as fast as possible.
...
1. Install X with ``pip3 install -U X``.
    ...
    .. code-block:: python
        ...
        async def main():
            async with Client("my_account", api_id, api_hash) as app:
                await app.send_message("me", "Greetings from **X**!")
...
8. Watch X send a message to yourself.
