...
X_API_DEST = "docs/source/api"

FUNCTIONS_PATH = "X/raw/functions"
TYPES_PATH = "X/raw/types"
BASE_PATH = "X/raw/base"
        ...
        for k, v in categories.items():
            ...
            for method in methods:
                with open(root + "/{}.rst".format(method), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. automethod:: X.Client.{}()".format(method))
            ...
            for func in functions:
                with open(root + "/{}.rst".format(func), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. autofunction:: X.{}()".format(func))
        ...
        for k, v in categories.items():
            ...
            for bm in bound_methods:
                with open(root + "/{}.rst".format(bm), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. automethod:: X.types.{}()".format(bm))
