...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~X.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~X.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~X.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~X.types.CallbackGame`, *optional*):
