...
class BotCommandScope(Object):
    ...
    - :obj:`~X.types.BotCommandScopeDefault`
    - :obj:`~X.types.BotCommandScopeAllPrivateChats`
    - :obj:`~X.types.BotCommandScopeAllGroupChats`
    - :obj:`~X.types.BotCommandScopeAllChatAdministrators`
    - :obj:`~X.types.BotCommandScopeChat`
    - :obj:`~X.types.BotCommandScopeChatAdministrators`
    - :obj:`~X.types.BotCommandScopeChatMember`
