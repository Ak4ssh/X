...
from X import types
from X import utils
from X.errors import MessageIdsEmpty, PeerIdInvalid
from X.parser import utils as parser_utils, Parser
...
class Message(Object, Update):
    ...
    Parameters:
        ...
        from_user (:obj:`~X.types.User`, *optional*):
            Sender, empty for messages sent to channels.

        sender_chat (:obj:`~X.types.Chat`, *optional*):
        ...
        chat (:obj:`~X.types.Chat`, *optional*):
            Conversation the message belongs to.

        forward_from (:obj:`~X.types.User`, *optional*):
        ...
        forward_from_chat (:obj:`~X.types.Chat`, *optional*):
        ...
        reply_to_message (:obj:`~X.types.Message`, *optional*):
        ...
        service (:obj:`~X.enums.MessageServiceType`, *optional*):
        ...
        media (:obj:`~X.enums.MessageMediaType`, *optional*):
        ...
        entities (List of :obj:`~X.types.MessageEntity`, *optional*):
            For text messages, special entities like usernames, URLs, bot commands, etc. that appear in the text.

        caption_entities (List of :obj:`~X.types.MessageEntity`, *optional*):
            For messages with a caption, special entities like usernames, URLs, bot commands, etc. that appear
            in the caption.

        audio (:obj:`~X.types.Audio`, *optional*):
            Message is an audio file, information about the file.

        document (:obj:`~X.types.Document`, *optional*):
            Message is a general file, information about the file.

        photo (:obj:`~X.types.Photo`, *optional*):
            Message is a photo, information about the photo.

        sticker (:obj:`~X.types.Sticker`, *optional*):
            Message is a sticker, information about the sticker.

        animation (:obj:`~X.types.Animation`, *optional*):
            Message is an animation, information about the animation.

        game (:obj:`~X.types.Game`, *optional*):
            Message is a game, information about the game.

        video (:obj:`~X.types.Video`, *optional*):
            Message is a video, information about the video.

        voice (:obj:`~X.types.Voice`, *optional*):
            Message is a voice message, information about the file.

        video_note (:obj:`~X.types.VideoNote`, *optional*):
        ...
        contact (:obj:`~X.types.Contact`, *optional*):
            Message is a shared contact, information about the contact.

        location (:obj:`~X.types.Location`, *optional*):
            Message is a shared location, information about the location.

        venue (:obj:`~X.types.Venue`, *optional*):
            Message is a venue, information about the venue.

        web_page (:obj:`~X.types.WebPage`, *optional*):
            Message was sent with a webpage preview.

        poll (:obj:`~X.types.Poll`, *optional*):
            Message is a native poll, information about the poll.

        dice (:obj:`~X.types.Dice`, *optional*):
            A dice containing a value that is randomly generated by Telegram.

        new_chat_members (List of :obj:`~X.types.User`, *optional*):
            New members that were added to the group or supergroup and information about them
            (the bot itself may be one of these members).

        left_chat_member (:obj:`~X.types.User`, *optional*):
            A member was removed from the group, information about them (this member may be the bot itself).

        new_chat_title (``str``, *optional*):
            A chat title was changed to this value.

        new_chat_photo (:obj:`~X.types.Photo`, *optional*):
        ...
        pinned_message (:obj:`~X.types.Message`, *optional*):
            Specified message was pinned.
            Note that the Message object in this field will not contain further reply_to_message fields even if it
            is itself a reply.

        game_high_score (:obj:`~X.types.GameHighScore`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the text of this message. Only applicable when using :obj:`Filters.regex <X.Filters.regex>`.

        command (List of ``str``, *optional*):
            A list containing the command and its arguments, if any.
            E.g.: "/start 1 2 3" would produce ["start", "1", "2", "3"].
            Only applicable when using :obj:`~X.filters.command`.

        video_chat_scheduled (:obj:`~X.types.VideoChatScheduled`, *optional*):
            Service message: voice chat scheduled.

        video_chat_started (:obj:`~X.types.VideoChatStarted`, *optional*):
            Service message: the voice chat started.

        video_chat_ended (:obj:`~X.types.VideoChatEnded`, *optional*):
            Service message: the voice chat has ended.

        video_chat_members_invited (:obj:`~X.types.VoiceChatParticipantsInvited`, *optional*):
            Service message: new members were invited to the voice chat.

        web_app_data (:obj:`~X.types.WebAppData`, *optional*):
            Service message: web app data sent to the bot.

        reply_markup (:obj:`~X.types.InlineKeyboardMarkup` | :obj:`~X.types.ReplyKeyboardMarkup` | :obj:`~X.types.ReplyKeyboardRemove` | :obj:`~X.types.ForceReply`, *optional*):
            Additional interface options. An object for an inline keyboard, custom reply keyboard,
            instructions to remove reply keyboard or to force a reply from the user.

        reactions (List of :obj:`~X.types.Reaction`):
    ...
    async def get_media_group(self) -> List["types.Message"]:
        """Bound method *get_media_group* of :obj:`~X.types.Message`.
        ...
        Returns:
            List of :obj:`~X.types.Message`: On success, a list of messages of the media group is returned.
    ...
    async def reply_text(
        ...
        """Bound method *reply_text* of :obj:`~X.types.Message`.
        ...
        Parameters:
            ...
            parse_mode (:obj:`~X.enums.ParseMode`, *optional*):
                By default, texts are parsed using both Markdown and HTML styles.
                You can combine both syntaxes together.

            entities (List of :obj:`~X.types.MessageEntity`):
    ...
    async def reply_animation(
        ...
        """Bound method *reply_animation* :obj:`~X.types.Message`.
        ...
        Parameters:
            ...
            caption_entities (List of :obj:`~X.types.MessageEntity`):
        ...
        Returns:
            On success, the sent :obj:`~X.types.Message` is returned.
            In case the upload is deliberately stopped with :meth:`~X.Client.stop_transmission`, None is returned
            instead.
    ...
    async def reply_audio(
        ...
        """Bound method *reply_audio* of :obj:`~X.types.Message`.
    ...
    async def reply_cached_media(
        ...
        """Bound method *reply_cached_media* of :obj:`~X.types.Message`.
    ...
    async def reply_chat_action(self, action: "enums.ChatAction") -> bool:
        """Bound method *reply_chat_action* of :obj:`~X.types.Message`.
    ...
    async def reply_contact(
        ...
        """Bound method *reply_contact* of :obj:`~X.types.Message`.
    ...
    async def reply_document(
        ...
        """Bound method *reply_document* of :obj:`~X.types.Message`.
    ...
    async def reply_game(
        ...
        """Bound method *reply_game* of :obj:`~X.types.Message`.
        ...
        Parameters:
            ...
            reply_markup (:obj:`~X.types.InlineKeyboardMarkup`, *optional*):
    ...
    async def reply_inline_bot_result(
        ...
        """Bound method *reply_inline_bot_result* of :obj:`~X.types.Message`.
    ...
    async def reply_location(
        ...
        """Bound method *reply_location* of :obj:`~X.types.Message`.
    ...
    async def reply_media_group(
        ...
        """Bound method *reply_media_group* of :obj:`~X.types.Message`.
        ...
        Parameters:
            media (``list``):
                A list containing either :obj:`~X.types.InputMediaPhoto` or
                :obj:`~X.types.InputMediaVideo` objects
        ...
        Returns:
            On success, a :obj:`~X.types.Messages` object is returned containing all the
    ...
    async def reply_photo(
        ...
        """Bound method *reply_photo* of :obj:`~X.types.Message`.
    ...
    async def reply_poll(
        ...
        """Bound method *reply_poll* of :obj:`~X.types.Message`.
        ...
        Parameters:
            ...
            type (:obj`~X.enums.PollType`, *optional*):
                Poll type, :obj:`~X.enums.PollType.QUIZ` or :obj:`~X.enums.PollType.REGULAR`.
                Defaults to :obj:`~X.enums.PollType.REGULAR`.
            ...
            explanation_parse_mode (:obj:`~X.enums.ParseMode`, *optional*):
                By default, texts are parsed using both Markdown and HTML styles.
                You can combine both syntaxes together.

            explanation_entities (List of :obj:`~X.types.MessageEntity`):
    ...
    async def reply_sticker(
        ...
        """Bound method *reply_sticker* of :obj:`~X.types.Message`.
    ...
    async def reply_venue(
        ...
        """Bound method *reply_venue* of :obj:`~X.types.Message`.
    ...
    async def reply_video(
        ...
        """Bound method *reply_video* of :obj:`~X.types.Message`.
    ...
    async def reply_video_note(
        ...
        """Bound method *reply_video_note* of :obj:`~X.types.Message`.
    ...
    async def reply_voice(
        ...
        """Bound method *reply_voice* of :obj:`~X.types.Message`.
    ...
    async def edit_text(
        ...
        """Bound method *edit_text* of :obj:`~X.types.Message`.
        ...
        Returns:
            On success, the edited :obj:`~X.types.Message` is returned.
    ...
    async def edit_caption(
        ...
        """Bound method *edit_caption* of :obj:`~X.types.Message`.
    ...
    async def edit_media(
        ...
        """Bound method *edit_media* of :obj:`~X.types.Message`.
    ...
    async def edit_reply_markup(self, reply_markup: "types.InlineKeyboardMarkup" = None) -> "Message":
        """Bound method *edit_reply_markup* of :obj:`~X.types.Message`.
        ...
        Parameters:
            reply_markup (:obj:`~X.types.InlineKeyboardMarkup`):
                An InlineKeyboardMarkup object.

        Returns:
            On success, if edited message is sent by the bot, the edited
            :obj:`~X.types.Message` is returned, otherwise True is returned.
    ...
    async def forward(
        ...
        """Bound method *forward* of :obj:`~X.types.Message`.
    ...
    async def copy(
        ...
        """Bound method *copy* of :obj:`~X.types.Message`.
        ...
        Returns:
            :obj:`~X.types.Message`: On success, the copied message is returned.
    ...
    async def delete(self, revoke: bool = True):
        """Bound method *delete* of :obj:`~X.types.Message`.
    ...
    async def click(self, x: Union[int, str] = 0, y: int = None, quote: bool = None, timeout: int = 10):
        """Bound method *click* of :obj:`~X.types.Message`.
        ...
        Returns:
            -   The result of :meth:`~X.Client.request_callback_answer` in case of inline callback button clicks.
    ...
    async def react(self, emoji: str = "") -> bool:
        """Bound method *react* of :obj:`~X.types.Message`.
    ...
    async def retract_vote(
        ...
        """Bound method *retract_vote* of :obj:`~X.types.Message`.
        ...
        Returns:
            :obj:`~X.types.Poll`: On success, the poll with the retracted vote is returned.
    ...
    async def download(
        ...
        """Bound method *download* of :obj:`~X.types.Message`.
    ...
    async def vote(
        ...
        """Bound method *vote* of :obj:`~X.types.Message`.
        ...
        Returns:
            :obj:`~X.types.Poll`: On success, the poll with the chosen option is returned.
    ...
    async def pin(self, disable_notification: bool = False, both_sides: bool = False) -> "types.Message":
        """Bound method *pin* of :obj:`~X.types.Message`.
        ...
        Returns:
            :obj:`~X.types.Message`: On success, the service message is returned.
    ...
    async def unpin(self) -> bool:
        """Bound method *unpin* of :obj:`~X.types.Message`.
