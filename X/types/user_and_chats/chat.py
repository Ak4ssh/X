...
class Chat(Object):
    ...
    Parameters:
        ...
        photo (:obj:`~X.types.ChatPhoto`, *optional*):
            Chat photo. Suitable for downloads only.

        bio (``str``, *optional*):
            Bio of the other party in a private chat.
            Returned only in :meth:`~X.Client.get_chat`.
        ...
        restrictions (List of :obj:`~X.types.Restriction`, *optional*):
            The list of reasons why this chat might be unavailable to some users.
            This field is available only in case *is_restricted* is True.

        permissions (:obj:`~X.types.ChatPermissions` *optional*):
            Default chat member permissions, for groups and supergroups.

        distance (``int``, *optional*):
            Distance in meters of this group chat from your location.
            Returned only in :meth:`~X.Client.get_nearby_chats`.

        linked_chat (:obj:`~X.types.Chat`, *optional*):
            The linked discussion group (in case of channels) or the linked channel (in case of supergroups).
            Returned only in :meth:`~X.Client.get_chat`.

        send_as_chat (:obj:`~X.types.Chat`, *optional*):
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~X.types.Chat`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~X.types.Chat`.
    ...
    async def set_title(self, title: str) -> bool:
        """Bound method *set_title* of :obj:`~X.types.Chat`.
    ...
    async def set_description(self, description: str) -> bool:
        """Bound method *set_description* of :obj:`~X.types.Chat`.
    ...
    async def set_photo(self, photo: str) -> bool:
        """Bound method *set_photo* of :obj:`~X.types.Chat`.
        ...
        Parameters:
            photo (``str``):
                New chat photo. You can pass a :obj:`~X.types.Photo` id or a file path to upload a new photo.
    ...
    async def ban_member(
        ...
        """Bound method *ban_member* of :obj:`~X.types.Chat`.
        ...
        Returns:
            :obj:`~X.types.Message` | ``bool``: On success, a service message will be returned (when applicable), otherwise, in
    ...
    async def unban_member(
        ...
        """Bound method *unban_member* of :obj:`~X.types.Chat`.
    ...
    async def restrict_member(
        ...
        Parameters:
            ...
            permissions (:obj:`~X.types.ChatPermissions`):
        ...
        Returns:
            :obj:`~X.types.Chat`: On success, a chat object is returned.
    ...
    async def promote_member(
        ...
        """Bound method *promote_member* of :obj:`~X.types.Chat`.
        ...
        Parameters:
            ...
            privileges (:obj:`~X.types.ChatPrivileges`, *optional*):
                New user privileges.
    ...
    async def join(self):
        """Bound method *join* of :obj:`~X.types.Chat`.
    ...
    async def leave(self):
        """Bound method *leave* of :obj:`~X.types.Chat`.
    ...
    async def export_invite_link(self):
        """Bound method *export_invite_link* of :obj:`~X.types.Chat`.
    ...
    async def get_member(
        ...
        """Bound method *get_member* of :obj:`~X.types.Chat`.
        ...
        Returns:
            :obj:`~X.types.ChatMember`: On success, a chat member is returned.
        """
    ...
    async def get_members(
        ...
        """Bound method *get_members* of :obj:`~X.types.Chat`.
        ...
        Parameters:
            query (``str``, *optional*):
                ...
                A query string is applicable only for :obj:`~X.enums.ChatMembersFilter.SEARCH`,
                :obj:`~X.enums.ChatMembersFilter.BANNED` and :obj:`~X.enums.ChatMembersFilter.RESTRICTED`
                filters only.

            limit (``int``, *optional*):
                Limits the number of members to be retrieved.

            filter (:obj:`~X.enums.ChatMembersFilter`, *optional*):
                Filter used to select the kind of members you want to retrieve. Only applicable for supergroups
                and channels.

        Returns:
            ``Generator``: On success, a generator yielding :obj:`~X.types.ChatMember` objects is returned.
        """
    ...
    async def add_members(
        ...
        """Bound method *add_members* of :obj:`~X.types.Chat`.
    ...
    async def mark_unread(self, ) -> bool:
        """Bound method *mark_unread* of :obj:`~X.types.Chat`.
    ...
    async def set_protected_content(self, enabled: bool) -> bool:
        """Bound method *set_protected_content* of :obj:`~X.types.Chat`.
    ...
    async def unpin_all_messages(self) -> bool:
        """Bound method *unpin_all_messages* of :obj:`~X.types.Chat`.
