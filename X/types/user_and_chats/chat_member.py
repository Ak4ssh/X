...
import X
from X import raw, types, utils, enums
...
class ChatMember(Object):
    ...
    Parameters:
        status (:obj:`~X.enums.ChatMemberStatus`):
        ...
        invited_by (:obj:`~X.types.User`, *optional*):
