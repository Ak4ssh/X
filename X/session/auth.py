...
import X
from X import raw
from X.connection import Connection
from X.crypto import aes, rsa, prime
from X.errors import SecurityCheckMismatch
from X.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "X.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
