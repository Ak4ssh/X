...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~X.handlers.ChosenInlineResultHandler`.

        Parameters:
            filters (:obj:`~X.filters`, *optional*):
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, X.Client):
                self.add_handler(X.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        X.handlers.ChosenInlineResultHandler(func, self),
