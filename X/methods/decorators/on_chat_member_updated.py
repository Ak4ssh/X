...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~X.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, X.Client):
                self.add_handler(X.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        X.handlers.ChatMemberUpdatedHandler(func, self),
