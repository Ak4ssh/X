...
import X
from X import StopTransmission, enums
from X import raw
from X import types
from X import utils
from X.errors import FilePartMissing
from X.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~X.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~X.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~X.Client.stop_transmission`, None is returned.
