...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~X.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~X.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~X.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "X". Get the first 50 results
                async for message in app.search_global("X", limit=50):
                    print(message.text)
