...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~X.types.InputMediaPhoto`, :obj:`~X.types.InputMediaVideo`, :obj:`~X.types.InputMediaAudio` and :obj:`~X.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~X.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from X.types import InputMediaPhoto, InputMediaVideo
