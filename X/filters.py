...
import X
from X import enums
from X.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "X.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~X.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~X.handlers.MessageHandler` the *update* argument will be a :obj:`~X.types.Message`; in a :obj:`~X.handlers.CallbackQueryHandler` the *update* will be a :obj:`~X.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~X.filters.command` or :meth:`~X.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~X.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~X.types.Document` objects."""
...
"""Filter messages that contain :obj:`~X.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~X.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~X.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~X.types.Game` objects."""
...
"""Filter messages that contain :obj:`~X.types.Video` objects."""
...
"""Filter messages that contain :obj:`~X.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~X.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~X.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~X.types.Location` objects."""
...
"""Filter messages that contain :obj:`~X.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~X.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~X.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~X.types.Message`.
    ...
    async def func(flt, client: X.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~X.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~X.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~X.types.InlineQuery`: The filter will match ``query``.
